    ...
    if (modal) {
        ...
        const projectsData = {
            forest: {
                ...
                clay: 'url(assets/forest-raw.jpg)', // Cambiar a: url(assets/proyectos/forest-clay.jpg)
                final: 'url(assets/forest.jpg)', // Cambiar a: url(assets/proyectos/forest-final.jpg)
            },
            pool: {
                title: 'Pool',
